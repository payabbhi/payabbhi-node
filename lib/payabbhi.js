...
const PaymentLink  = require('./payment_link');
const BeneficiaryAccount = require('./beneficiaryaccount');
const VirtualAccount = require('./virtual_account');
...
class Payabbhi {
  constructor(accessId, secretKey) {
    ...
    this.settlements          = new Settlement(this.config);
    this.payment_links        = new PaymentLink(this.config);
    this.virtual_accounts     = new VirtualAccount(this.config);
    this.beneficiaryaccounts = new BeneficiaryAccount(this.config);
  }
