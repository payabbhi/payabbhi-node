...
class Payment extends Resource{
  ...
  transfer(sourceId, params, cb) {
    var p = Helpers.sanitize(params, cb);
    return super.request('POST',  Helpers.nurl(this, sourceId, 'transfers'), p.params, p.cb)
  }

  virtual_account(id, cb) {
    return super.request('GET', Helpers.nurl(this,id,'virtual_account'),{},cb);
  }
}
